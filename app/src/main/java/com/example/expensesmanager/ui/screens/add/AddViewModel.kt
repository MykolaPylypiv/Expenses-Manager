...
class AddViewModel @Inject constructor(
    ...
    val addOperationsList = mutableStateListOf<AddCategory>()
    ...
    fun machiningOperations(isCosts: Boolean, operation: String) =
        if (isCosts) "-$operation" else operation
    ...
    fun financesList(
        isCosts: Boolean, incomes: List<Category>, costs: List<Category>
    ): List<CategoryIcon> {
