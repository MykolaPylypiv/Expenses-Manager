...
sealed interface ListIcons {
    ...
    class Food(language: Language) : ListIcons {
    ...
    class Cafe(language: Language) : ListIcons {
    ...
    class Transport(language: Language) : ListIcons {
    ...
    class Health(language: Language) : ListIcons {
    ...
    class Pets(language: Language) : ListIcons {
    ...
    class Family(language: Language): ListIcons {
    ...
    class Clothes(language: Language) : ListIcons {
    ...
    class Entertainment(language: Language) : ListIcons {
    ...
    class Salary(language: Language) : ListIcons {
